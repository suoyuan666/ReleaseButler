 ...
 * It's the parsing of the file that implements all of the features allowed for installation.
 *
 * @param url The home page of the website where the program is hosted
 * @param name Name of the software
 * @param pack_name Name of the package to download, e.g. `fastfetch-linux-amd64.deb`
 * @param vmode Whether to output more information (for debugging purposes)
 * @param install Whether to call the corresponding package manager to install after download
